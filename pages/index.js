    ...
    <div className={styles.wrapper}>
      ...
      <section className={styles.text}>
        <article className={styles.intro}>
          ...
          <h2 className={styles.thought}>Bah. All text.</h2>
          <p>
          ...
          <h2 className={styles.thought}>I wish I could read Chinese...</h2>
          <p>
            You should learn! But its a long road from here to fluency, and your stomach hasn't got that kind of time.
            Let those further on that road give you a hand along the way with Eatt.
          </p>
        </article>
        <hr />
